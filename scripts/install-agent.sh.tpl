...
# 2. Pre-create the RKE2 configuration directory
mkdir -p /etc/rancher/rke2/

# 3. Write the configuration file to join the cluster
...
curl -sfL https://get.rke2.io | INSTALL_RKE2_TYPE="agent" INSTALL_RKE2_VERSION="v1.36.2+rke2r1" sh -
